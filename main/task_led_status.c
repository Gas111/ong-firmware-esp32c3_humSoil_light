...
static const uint8_t state_colors[SYSTEM_STATE_MAX][3] = {
    ...
    [SYSTEM_STATE_INIT] = {255, 200, 0},             // Amarillo - Inicialización
    [SYSTEM_STATE_WIFI] = {255, 255, 255},           // Blanco  - Conectando WiFi
    [SYSTEM_STATE_CONFIG] = {0, 0, 255},             // Azul    - Configurando sensores
    [SYSTEM_STATE_READY] = {0, 255, 0},              // Verde   - Sistema listo
    [SYSTEM_STATE_SENSOR_READ] = {0, 255, 128},      // Verde claro - Leyendo sensor
    [SYSTEM_STATE_HTTP_SEND] = {128, 0, 255},        // Violeta - Enviando HTTP
    [SYSTEM_STATE_ERROR] = {255, 0, 0},              // Rojo    - Error crítico
    [SYSTEM_STATE_ESPERANDO_WIFI] = {255, 128, 0},   // Naranja - Esperando WiFi
    [SYSTEM_STATE_PROVISIONING] = {255, 0, 255},     // Magenta - Provisioning
    [SYSTEM_STATE_WARNING] = {255, 255, 0},          // Amarillo brillante - Advertencia
};
